...
namespace TShockIRC
{
	public static class TSIrcClient
	{
		public static Config Config = new Config();
		public static CtcpClient CtcpClient;
		public static StandardIrcClient IrcClient = new StandardIrcClient();
		public static Dictionary<IrcUser, TShockAPI.Group> IrcUsers = new Dictionary<IrcUser, TShockAPI.Group>();
		...
		public static void Connect()
		{
			...
			CtcpClient = new CtcpClient(IrcClient) { ClientVersion = "TShockIRC v" + Assembly.GetEntryAssembly().GetName().Version };
		}
		...
		private static void OnIRCDisconnected(object sender, EventArgs e)
		{
			Connect();
		}
		private static void OnIRCRegistered(object sender, EventArgs e)
		{
			Connecting = false;
		...
		private static void OnIRCJoinedChannel(object sender, IrcChannelEventArgs e)
		{
		...
		private static void OnIRCMessageReceived(object sender, IrcMessageEventArgs e)
		{
			IRCCommands.Execute(e.Text, (IrcUser)e.Source, (IIrcMessageTarget)e.Source);
		}

		private static void OnChannelJoined(object sender, IrcChannelUserEventArgs e)
		{
		...
		private static void OnChannelKicked(object sender, IrcChannelUserEventArgs e)
		{
			if (Config.IgnoredIRCNicks.Contains(e.ChannelUser.User.NickName))
				return;
		...
		private static void OnChannelLeft(object sender, IrcChannelUserEventArgs e)
		{
			if (Config.IgnoredIRCNicks.Contains(e.ChannelUser.User.NickName))
				return;
		...
		private static void OnChannelMessage(object sender, IrcMessageEventArgs e)
		{
		...
		private static void OnUserQuit(object sender, IrcCommentEventArgs e)
		{
